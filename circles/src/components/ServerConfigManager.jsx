...
const ServerConfigManager = () => {
    const [currentVersion, setCurrentVersion] = useState(import.meta.env.VITE_APP_VERSION);
    ...
    useEffect(() => {
        ...
        serverConfig?.min_version,
        currentVersion,
        hasBeenInitialized,
        setLatestRefreshedVersion,
        latestRefreshedVersion,
    ]);
                    ...
                    <ModalContent>
                        ...
                        <ModalFooter>
                            <Button
                                colorScheme="blue"
                                mr={3}
                                onClick={() => handleRefresh(serverConfig?.min_version, setLatestRefreshedVersion)}
                            >
                                Reload
                            </Button>
