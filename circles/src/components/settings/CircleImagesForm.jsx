                        ...
                        <Flex flexDirection="column">
                            ...
                            >
                                ...
                                {circle?.type !== "post" && (
                                    <Box height="76px" position="relative" top="-38px">
                                        {!isUpdateForm && circlePicturePreview && (
                                            <Image
                                                marginTop="3.5px"
                                                className="circle-list-picture"
                                                src={circlePicturePreview}
                                            />
                                        )}
                                ...
                                <VStack
                                    align="center"
                                    spacing="12px"
                                    marginTop={circle?.type === "post" ? "0px" : "-28px"}
                                >
                                    ...
                                    <Field name="picture">
                                        {({ field, form }) => (
                                            <FormControl isInvalid={form.errors.picture && form.touched.picture}>
                                                <FormLabel>
                                                    {circle?.type === "user" ? "Profile picture" : i18n.t("Logo")}
                                                </FormLabel>
                                                <InputGroup>
                                                    <input
                                                        name="picture"
                                                ...
                                                <HStack align="center" spacing="15px">
                                                    <Button
                                                        ...
                                                        onClick={handleCirclePictureUploadClick}
                                                    >
                                                        {circle.type === "user"
                                                            ? i18n.t(`Choose profile picture`)
                                                            : i18n.t(`Choose logo`)}
                                                    </Button>
                                    ...
                                    {({ field, form }) => (
                                        <FormControl isInvalid={form.errors.cover && form.touched.cover}>
                                            ...
                                            <HStack align="center" marginTop="10px" spacing="15px">
                                                <Button
                                                    leftIcon={<Icon as={FiFile} />}
                                                    onClick={handleCircleCoverUploadClick}
                                                >
