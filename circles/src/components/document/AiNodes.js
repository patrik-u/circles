//#region imports
import { DecoratorNode, TextNode, EditorConfig, NodeKey, SerializedLexicalNode } from "lexical";
    ...
    decorate() {
        return (
            <span style={{ color: "#ccc" }} spellCheck="false">
                <img src="/Spinner-1s-20px.gif" style={{ display: "inline", width: "1em", height: "1em", verticalAlign: "middle" }} alt="spinner" />
            </span>
        );
    }
}
