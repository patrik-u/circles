                                        ...
                                        {({ field, form }) => (
                                            <VStack align="left" flexGrow="1">
                                                ...
                                                <ChakraSelect
                                                    ...
                                                    name="time"
                                                    id="time"
                                                    placeholder={i18n.t("Specify time")}
                                                    isDisabled={isAllDay}
                                                >
                                                ...
                                                <FormControl
                                                    isInvalid={form.errors.time && form.touched.time && !isAllDay}
                                                >
                                        ...
                                        {({ field, form }) => (
                                            ...
                                            >
                                                ...
                                                <Text
                                                    ...
                                                    color="#bbb"
                                                >
                                                    {form?.values?.description ? form.values.description.length : 0} /
                                                    200
                                                </Text>
                                                <InputGroup>
                                                    <Textarea
                                    ...
                                    <Field name="isPublic">
                                        {({ field, form }) => (
                                            <FormControl isInvalid={form.errors.isPublic && form.touched.isPublic}>
                                                <Checkbox
                                                    isChecked={isPublicSetting}
                                                    id="isPublic"
                                                    onChange={(e) => setIsPublicSetting(e.target.checked)}
                                                >
