                                            ...
                                            <RadioGroup id="type" {...rest}>
                                                ...
                                                >
                                                    <Radio onChange={onChange} value="circle">
                                                        <HStack spacing="10px">
                                                            ...
                                                            <VStack align="start" spacing="0px">
                                                                ...
                                                                <Text textAlign="left">
                                                                    {i18n.t(
                                                                        "Circle of people gathering around a common cause"
                                                                    )}
                                                                </Text>
                                                            </VStack>
                                                        </HStack>
                                                    ...
                                                    <Radio onChange={onChange} value="event">
                                                        <HStack spacing="10px">
                                                            ...
                                                            <VStack align="start" spacing="0px">
                                                                ...
                                                                <Text textAlign="left">
                                                                    {i18n.t(
                                                                        "An activity that takes place at a certain date"
                                                                    )}
                                                                </Text>
                                                            </VStack>
                                                        </HStack>
                                                    ...
                                                    <Radio onChange={onChange} value="document">
                                                        <HStack spacing="10px">
                                                            <Image
                                                                src="/circle-document-option.png"
                                                                width="100px"
                                                                height="100px"
                                                            />
                                                            <VStack align="start" spacing="0px">
                                                                ...
                                                                <Text textAlign="left">
                                                                    {i18n.t(
                                                                        "Public document such as code of conduct, constitution & bylaws, meeting minutes, manifesto, etc."
                                                                    )}
                                                                </Text>
                                                            </VStack>
                                                        </HStack>
                                                    ...
                                                    {user?.is_admin && (
                                                        <Radio onChange={onChange} value="ai_agent">
                                                            <HStack spacing="10px">
                                                                <Image
                                                                    src="/circle-ai_agent-option.png"
                                                                    width="100px"
                                                                    height="100px"
                                                                />
                                                                <VStack align="start" spacing="0px">
