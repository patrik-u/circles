                        ...
                        <VStack align="center">
                            ...
                            <VStack align="center" spacing="25px" width="100%" marginLeft="25px" marginRight="25px">
                                <Field name="openCollective">
                                    {({ field, form }) => (
                                        <FormControl
                                            isInvalid={form.errors.openCollective && form.touched.openCollective}
                                        >
                                            ...
                                            <Text
                                                ...
                                                color="#bbb"
                                            >
                                                {form?.values?.openCollective ? form.values.openCollective.length : 0} /
                                                200
                                            </Text>
                                            <InputGroup>
                                                <Input
                                        ...
                                        <FormControl isInvalid={form.errors.paypal && form.touched.paypal}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="paypal"
                                                    type="text"
                                                    placeholder={i18n.t("PayPal link")}
                                                    maxLength="200"
                                                />
                                                {!form.errors.paypal && form.touched.paypal && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
