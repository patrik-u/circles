                    ...
                    <VStack align="center">
                        ...
                        <VStack align="center" spacing="25px" width="100%" marginLeft="25px" marginRight="25px">
                            <Field name="name_confirmation">
                                {({ field, form }) => (
                                    <FormControl
                                        isInvalid={form.errors.name_confirmation && form.touched.name_confirmation}
                                    >
                                        <FormLabel>
                                            {i18n.t("Confirm deletion of circle by entering the name of the circle")}
                                        </FormLabel>
                                        <InputGroup>
                                            <Input
                                                {...field}
                                                id="name_confirmation"
                                                ref={deleteCircleInitialRef}
                                                type="text"
                                                maxLength="50"
                                            />
