                                        ...
                                        <FormControl isInvalid={form.errors.facebook && form.touched.facebook}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="facebook"
                                                    type="text"
                                                    placeholder={i18n.t("Facebook example")}
                                                    maxLength="200"
                                                />
                                        ...
                                        <FormControl isInvalid={form.errors.twitter && form.touched.twitter}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="twitter"
                                                    type="text"
                                                    placeholder={i18n.t("Twitter example")}
                                                    maxLength="200"
                                                />
                                        ...
                                        <FormControl isInvalid={form.errors.instagram && form.touched.instagram}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="instagram"
                                                    type="text"
                                                    placeholder={i18n.t("Instagram example")}
                                                    maxLength="200"
                                                />
                                        ...
                                        <FormControl isInvalid={form.errors.youtube && form.touched.youtube}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="youtube"
                                                    type="text"
                                                    placeholder={i18n.t("YouTube example")}
                                                    maxLength="200"
                                                />
                                        ...
                                        <FormControl isInvalid={form.errors.tiktok && form.touched.tiktok}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="tiktok"
                                                    type="text"
                                                    placeholder={i18n.t("TikTok example")}
                                                    maxLength="200"
                                                />
                                                {!form.errors.tiktok && form.touched.tiktok && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
                                        ...
                                        <FormControl isInvalid={form.errors.linkedin && form.touched.linkedin}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="linkedin"
                                                    type="text"
                                                    placeholder={i18n.t("LinkedIn example")}
                                                    maxLength="200"
                                                />
                                        ...
                                        <FormControl isInvalid={form.errors.medium && form.touched.medium}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="medium"
                                                    type="text"
                                                    placeholder={i18n.t("Medium example")}
                                                    maxLength="200"
                                                />
                                                {!form.errors.medium && form.touched.medium && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
                                        ...
                                        <FormControl isInvalid={form.errors.link1 && form.touched.link1}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    id="link1"
                                                    type="text"
                                                    placeholder={i18n.t("Link example")}
                                                    maxLength="200"
                                                />
                                                {!form.errors.link1 && form.touched.link1 && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
                                        ...
                                        <FormControl isInvalid={form.errors.link2 && form.touched.link2}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    maxLength="200"
                                                />
                                                {!form.errors.link2 && form.touched.link2 && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
                                        ...
                                        <FormControl isInvalid={form.errors.link3 && form.touched.link3}>
                                            ...
                                            <InputGroup>
                                                <Input
                                                    ...
                                                    maxLength="200"
                                                />
                                                {!form.errors.link3 && form.touched.link3 && (
                                                    <InputRightElement children={<CheckIcon color="green.500" />} />
                                                )}
                                            </InputGroup>
