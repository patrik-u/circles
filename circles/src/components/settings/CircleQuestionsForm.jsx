...
const QuestionForm = ({ index, questions, setQuestions, type, isGuideForm, circleId, setIsAnswering }) => {
    ...
    const getShuffledQuestions = () => {
        let filteredQuestions = allQuestions.filter(
            (x) =>
                ...
                questions?.question1?.id !== x.id &&
                questions?.question2?.id !== x.id &&
                questions?.question3?.id !== x.id
        );
